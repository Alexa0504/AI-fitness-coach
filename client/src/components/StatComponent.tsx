...
const GamificationCard: React.FC = () => {
    return (
        <div className="flex flex-col space-y-4">
            <div
                className="p-4 bg-yellow-100 dark:bg-yellow-900/50 border border-yellow-300 dark:border-yellow-700 rounded-xl text-center shadow-lg transition duration-300 hover:shadow-xl">
            ...
            <div
                className="p-4 bg-green-100 dark:bg-green-900/50 border border-green-300 dark:border-green-700 rounded-xl text-center shadow-lg transition duration-300 hover:shadow-xl">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                <h3 className="text-2xl font-bold text-base-content mb-4 border-b border-gray-200 dark:border-gray-700 pb-2 transition-colors duration-300">
                    Következő Célok
                </h3>
