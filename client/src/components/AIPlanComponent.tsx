...
const AiPlanCard: React.FC<AiPlanCardProps> = ({ workoutPlan, dietPlan, onPlanUpdate, onPlansLoaded, addXp }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-base-200/70 p-4 rounded-xl border border-base-300 shadow-md text-base-content space-y-4">
                ...
                {activeType === "workout" && plan.days?.map((day, idx) => (
                    <div key={idx} className="p-3 rounded-lg bg-base-300/60 border border-base-300">
                        <div className="flex items-center justify-between">
                            ...
                            <label className="flex items-center gap-2">
                                <input type="checkbox" checked={day.completed} disabled={day.completed} onChange={() => handleToggle(day.day)} /> Done
                            </label>
                        </div>
                ...
                {activeType === "diet" && plan.meals?.map((day, idx) => (
                    <div key={idx} className="p-3 rounded-lg bg-base-300/60 border border-base-300">
